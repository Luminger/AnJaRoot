...
/* Read one mount table entry from STREAM. Returns a pointer to storage
 ...
 check). */
struct local_mntent *local_getmntent_r (FILE *stream, struct local_mntent *mp, char *buffer, int bufsiz)
{
    char *cp;
    char *head;
...
struct local_mntent *local_getmntent (FILE *stream)
{
    static struct local_mntent m;
    ...
    return local_getmntent_r (stream, &m, getmntent_buffer, BUFFER_SIZE);
    #undef BUFFER_SIZE
}
...
char *local_hasmntopt (const struct local_mntent *mnt, const char *opt)
{
